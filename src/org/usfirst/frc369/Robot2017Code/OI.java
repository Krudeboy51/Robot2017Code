...
public class OI {
    ...
    public OI() {
        ...
        x.whenPressed(new HangerClimbUp());
        x.whenReleased(new StopHanger());
        square = new JoystickButton(joystick1, 1);
        square.whenPressed(new HangerClimbDown());
        square.whenReleased(new StopHanger());
